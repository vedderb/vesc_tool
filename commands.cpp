...
{
    switch (fault) {
    case FAULT_CODE_BMS_NONE: return "NONE";
    case FAULT_CODE_BMS_CHARGE_OVERCURRENT: return "CHARGE_OVERCURRENT";
    case FAULT_CODE_BMS_CHARGE_OVERTEMP: return "CHARGE_OVERTEMP";
    case FAULT_CODE_ENNOID_BMS_NONE: return "NONE";
    case FAULT_CODE_ENNOID_BMS_PACK_OVER_VOLTAGE: return "PACK_OVER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_PACK_UNDER_VOLTAGE: return "PACK_UNDER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_LOAD_OVER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_LOAD_OVER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_LOAD_UNDER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_LOAD_UNDER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CHARGER_OVER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CHARGER_OVER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CHARGER_UNDER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CHARGER_UNDER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CELL_HARD_OVER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CELL_HARD_OVER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CELL_HARD_UNDER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CELL_HARD_UNDER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CELL_SOFT_OVER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CELL_SOFT_OVER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_CELL_SOFT_UNDER_VOLTAGE: return "FAULT_CODE_ENNOID_BMS_CELL_SOFT_UNDER_VOLTAGE";
    case FAULT_CODE_ENNOID_BMS_MAX_UVP_OVP_ERRORS: return "FAULT_CODE_ENNOID_BMS_MAX_UVP_OVP_ERRORS";
    case FAULT_CODE_ENNOID_BMS_MAX_UVT_OVT_ERRORS: return "FAULT_CODE_ENNOID_BMS_MAX_UVT_OVT_ERRORS";
    case FAULT_CODE_ENNOID_BMS_OVER_CURRENT: return "FAULT_CODE_ENNOID_BMS_OVER_CURRENT";
    case FAULT_CODE_ENNOID_BMS_OVER_TEMP_BMS: return "FAULT_CODE_ENNOID_BMS_OVER_TEMP_BMS";
    case FAULT_CODE_ENNOID_BMS_UNDER_TEMP_BMS: return "FAULT_CODE_ENNOID_BMS_UNDER_TEMP_BMS";
    case FAULT_CODE_ENNOID_BMS_DISCHARGE_OVER_TEMP_CELLS: return "FAULT_CODE_ENNOID_BMS_DISCHARGE_OVER_TEMP_CELLS";
    case FAULT_CODE_ENNOID_BMS_DISCHARGE_UNDER_TEMP_CELLS: return "FAULT_CODE_ENNOID_BMS_DISCHARGE_UNDER_TEMP_CELLS";
    case FAULT_CODE_ENNOID_BMS_CHARGE_OVER_TEMP_CELLS: return "FAULT_CODE_ENNOID_BMS_CHARGE_OVER_TEMP_CELLS";
    case FAULT_CODE_ENNOID_BMS_CHARGE_UNDER_TEMP_CELLS: return "FAULT_CODE_ENNOID_BMS_CHARGE_UNDER_TEMP_CELLS";
    case FAULT_CODE_ENNOID_BMS_PRECHARGE_TIMEOUT: return "FAULT_CODE_ENNOID_BMS_PRECHARGE_TIMEOUT";
    case FAULT_CODE_ENNOID_BMS_DISCHARGE_RETRY: return "FAULT_CODE_ENNOID_BMS_DISCHARGE_RETRY";
    case FAULT_CODE_ENNOID_BMS_CHARGE_RETRY: return "FAULT_CODE_ENNOID_BMS_CHARGE_RETRY";
    case FAULT_CODE_ENNOID_BMS_CAN_DELAYED_POWER_DOWN: return "FAULT_CODE_ENNOID_BMS_CAN_DELAYED_POWER_DOWN";
    case FAULT_CODE_ENNOID_BMS_NOT_USED_TIMEOUT: return "FAULT_CODE_ENNOID_BMS_NOT_USED_TIMEOUT";
    case FAULT_CODE_ENNOID_BMS_CHARGER_DISCONNECT: return "FAULT_CODE_ENNOID_BMS_CHARGER_DISCONNECT";
    case FAULT_CODE_ENNOID_BMS_CHARGER_CURRENT_THRESHOLD_TIMEOUT: return "FAULT_CODE_ENNOID_BMS_CHARGER_CURRENT_THRESHOLD_TIMEOUT";
    }
    return "Unknown fault";
...
{
    switch (opState) {
    case OP_STATE_INIT: return "NONE";
