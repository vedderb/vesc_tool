...
typedef enum {
    FAULT_CODE_BMS_NONE = 0,
    FAULT_CODE_BMS_CHARGE_OVERCURRENT,
    FAULT_CODE_BMS_CHARGE_OVERTEMP,

    FAULT_CODE_ENNOID_BMS_NONE = 150,
    FAULT_CODE_ENNOID_BMS_PACK_OVER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_PACK_UNDER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_LOAD_OVER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_LOAD_UNDER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CHARGER_OVER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CHARGER_UNDER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CELL_HARD_OVER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CELL_HARD_UNDER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CELL_SOFT_OVER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_CELL_SOFT_UNDER_VOLTAGE,
    FAULT_CODE_ENNOID_BMS_MAX_UVP_OVP_ERRORS,
    FAULT_CODE_ENNOID_BMS_MAX_UVT_OVT_ERRORS,
    FAULT_CODE_ENNOID_BMS_OVER_CURRENT,
    FAULT_CODE_ENNOID_BMS_OVER_TEMP_BMS,
    FAULT_CODE_ENNOID_BMS_UNDER_TEMP_BMS,
    FAULT_CODE_ENNOID_BMS_DISCHARGE_OVER_TEMP_CELLS,
    FAULT_CODE_ENNOID_BMS_DISCHARGE_UNDER_TEMP_CELLS,
    FAULT_CODE_ENNOID_BMS_CHARGE_OVER_TEMP_CELLS,
    FAULT_CODE_ENNOID_BMS_CHARGE_UNDER_TEMP_CELLS,
    FAULT_CODE_ENNOID_BMS_PRECHARGE_TIMEOUT,
    FAULT_CODE_ENNOID_BMS_DISCHARGE_RETRY,
    FAULT_CODE_ENNOID_BMS_CHARGE_RETRY,
    FAULT_CODE_ENNOID_BMS_CAN_DELAYED_POWER_DOWN,
    FAULT_CODE_ENNOID_BMS_NOT_USED_TIMEOUT,
    FAULT_CODE_ENNOID_BMS_CHARGER_DISCONNECT,
    FAULT_CODE_ENNOID_BMS_CHARGER_CURRENT_THRESHOLD_TIMEOUT
} bms_fault_code;
