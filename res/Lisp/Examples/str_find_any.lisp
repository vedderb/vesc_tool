...
(defun str-find-any (str seqs) (first (sort < (map (fn (x) (to-u (buf-find str x))) seqs))))
...
(defun str-find-anyx (str seqs)
    (first (sort < (map (fn (x) (to-u (buf-find str x)))
